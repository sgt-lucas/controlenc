...
def main(page: ft.Page):
    ...
    def show_main_layout(e=None):
        ...
        def switch_view(e):
            ...
            view_selecionada = all_views[index]
            view_container.content = view_selecionada
            view_container.update()
    
            # Após o update do container, chamamos o carregamento manualmente 
            # para garantir que a aba não fique em branco.
